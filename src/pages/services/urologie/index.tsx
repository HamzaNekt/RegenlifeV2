...
import { FiArrowRight, FiDroplet, FiHeart, FiPackage, FiActivity, FiAlertTriangle } from 'react-icons/fi';
...
const urologyServices = [
  ...
  },
  {
    ...
    description: 'Prévention, dépistage, traitements et accompagnement personnalisé pour le cancer de la prostate.',
    path: '/services/urologie/cancer-prostate',
...
const Urologie: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1c2431]">
      {/* Hero Section */}
      <section className="relative h-[55vh] flex items-center justify-center pt-32 overflow-hidden" style={{ backgroundImage: 'url(/herobackground.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'urologie', service: 'Générique' } })}
