...
const UrologiePRPTherapy: React.FC = () => {
    ...
    <div className="min-h-screen bg-[#1c2431]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-montserrat">
              Thérapie PRP en Urologie
            </h1>
            <p className="text-xl mb-8 font-montserrat">
              Une approche régénérative utilisant votre propre sang enrichi en plaquettes pour traiter la dysfonction érectile et les problèmes de prostate.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'urologie', service: 'Thérapie PRP' } })}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Qu'est-ce que la Thérapie PRP en Urologie ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              La thérapie PRP (Plasma Riche en Plaquettes) en urologie utilise votre propre sang enrichi en plaquettes pour stimuler la réparation et la régénération des tissus urologiques. Cette approche est particulièrement efficace pour traiter la dysfonction érectile et les problèmes de prostate.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                ...
                <p className="text-[#c4bcb4]">
                  Utilisation de votre propre sang enrichi en plaquettes, injection ciblée dans les tissus urologiques avec récupération rapide.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <p className="text-[#c4bcb4]">
                  Amélioration de la fonction érectile, réduction des symptômes de l'hyperplasie bénigne de la prostate et amélioration du contrôle urinaire.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Avantages de la Thérapie PRP en Urologie
            </h2>
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#c4bcb4]">
                    Stimulation naturelle de la régénération des tissus érectiles et amélioration de la fonction érectile.
                  </p>
                </div>
              </motion.div>
              <motion.div 
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-[#c4bcb4]">Procédure de thérapie PRP avec suivi urologique</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
...
export default UrologiePRPTherapy; 
