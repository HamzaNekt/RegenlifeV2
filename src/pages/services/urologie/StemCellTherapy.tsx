...
const UrologieStemCellTherapy: React.FC = () => {
    ...
    <div className="min-h-screen bg-[#1c2431]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-montserrat">
              Thérapie par Cellules Souches en Urologie
            </h1>
            <p className="text-xl mb-8 font-montserrat">
              Une approche régénérative avancée pour traiter les problèmes de prostate, la dysfonction érectile et les troubles urinaires.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'urologie', service: 'Thérapie par Cellules Souches' } })}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Qu'est-ce que la Thérapie par Cellules Souches en Urologie ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              La thérapie par cellules souches en urologie est une approche innovante qui utilise vos propres cellules souches pour réparer et régénérer les tissus urologiques endommagés. Cette technique est particulièrement efficace pour traiter les problèmes de prostate, la dysfonction érectile et les troubles urinaires.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                ...
                <p className="text-[#c4bcb4]">
                  Utilisation de cellules souches autologues prélevées de votre moelle osseuse ou de votre tissu adipeux, procédure mini-invasive avec récupération rapide.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <p className="text-[#c4bcb4]">
                  Amélioration significative de la fonction érectile, réduction des symptômes de l'hyperplasie bénigne de la prostate et amélioration du contrôle urinaire.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Avantages de la Thérapie par Cellules Souches en Urologie
            </h2>
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Traitement de la Dysfonction Érectile</h3>
                  <p className="text-[#c4bcb4]">
                    Régénération naturelle des tissus érectiles et amélioration de la fonction érectile sans effets secondaires.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Amélioration des Symptômes de la Prostate</h3>
                  <p className="text-[#c4bcb4]">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-[#c4bcb4]">Procédure de thérapie par cellules souches avec suivi urologique</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
...
export default UrologieStemCellTherapy; 