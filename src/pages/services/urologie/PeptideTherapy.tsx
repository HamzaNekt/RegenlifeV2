...
const UrologiePeptideTherapy: React.FC = () => {
    ...
    <div className="min-h-screen bg-[#1c2431]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-montserrat">
              Thérapie Peptidique en Urologie
            </h1>
            <p className="text-xl mb-8 font-montserrat">
              Une approche ciblée utilisant des peptides spécifiques pour traiter la dysfonction érectile, les problèmes de prostate et les troubles hormonaux.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'urologie', service: 'Thérapie Peptidique' } })}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Qu'est-ce que la Thérapie Peptidique en Urologie ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              La thérapie peptidique en urologie utilise des peptides spécifiques pour cibler et traiter les problèmes urologiques. Cette approche est particulièrement efficace pour la dysfonction érectile, les problèmes de prostate et les déséquilibres hormonaux.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                ...
                <p className="text-[#c4bcb4]">
                  Utilisation de peptides spécifiques pour la fonction érectile et la santé de la prostate, administration par injection ou voie orale.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <p className="text-[#c4bcb4]">
                  Amélioration de la fonction érectile, réduction des symptômes de la prostate et optimisation des niveaux hormonaux.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Avantages de la Thérapie Peptidique en Urologie
            </h2>
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#c4bcb4]">
                    Amélioration de la fonction érectile et de la libido grâce à des peptides spécifiques.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Optimisation Hormonale</h3>
                  <p className="text-[#c4bcb4]">
                    Régulation des niveaux hormonaux pour une meilleure santé urologique et sexuelle.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-[#c4bcb4]">Procédure de thérapie peptidique avec suivi urologique</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
...
export default UrologiePeptideTherapy; 
