...
import { FiArrowRight, FiCheckCircle, FiMapPin, FiTruck, FiHome, FiHeart } from 'react-icons/fi';
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <p className="text-xl mb-8 font-montserrat">
              Une surveillance précise de votre tension artérielle sur 24 heures pour un diagnostic optimal.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'radiologie', service: 'ABPM' } })}
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-6 font-montserrat">
              Qu'est-ce que l'ABPM ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              Une technique de surveillance de la tension artérielle qui mesure automatiquement votre pression sanguine sur une période de 24 heures.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Surveillance Continue</h3>
                <p className="text-[#c4bcb4] font-montserrat">
                  Mesures automatiques de la tension artérielle pendant vos activités quotidiennes.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <p className="text-[#c4bcb4] font-montserrat">
                  Évaluation complète de votre profil tensionnel sur 24 heures.
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Évaluation Complète</h3>
                  <p className="text-[#c4bcb4] font-montserrat">
                    Analyse détaillée des variations de tension artérielle sur 24 heures.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#c4bcb4] font-montserrat">
                    Surveillance précise pour un ajustement optimal du traitement.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Installation</h3>
                <p className="text-[#c4bcb4] font-montserrat">Mise en place du dispositif de surveillance et explications détaillées</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Surveillance</h3>
                <p className="text-[#c4bcb4] font-montserrat">Suivi continu de votre tension artérielle pendant 24 heures</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Analyse des Résultats</h3>
                <p className="text-[#c4bcb4] font-montserrat">Interprétation détaillée des données et recommandations personnalisées</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
        ...
        <section>
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-4 font-montserrat">
              Prêt à Surveiller Votre Tension Artérielle ?
            </h2>
            <p className="text-xl text-white/90 mb-8 font-montserrat">
              Prenez rendez-vous dès aujourd'hui pour votre examen ABPM
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
