  ...
  return (
    <div className="min-h-screen bg-[#1c2431]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <p className="text-xl mb-8 font-montserrat">
              Des examens d'imagerie médicale de pointe pour un diagnostic précis et un suivi optimal de votre santé.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'radiologie', service: 'Services de Radiologie' } })}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* What is Radiology Services Section */}
        <section className="mb-16">
          ...
          >
            ...
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              Une spécialité médicale utilisant des technologies d'imagerie avancées pour visualiser l'intérieur du corps et établir des diagnostics précis.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Technologies de Pointe</h3>
                <p className="text-[#c4bcb4] font-montserrat">
                  Utilisation d'équipements modernes pour des images de haute qualité et des diagnostics précis.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Expertise Médicale</h3>
                <p className="text-[#c4bcb4] font-montserrat">
                  Interprétation des images par des radiologues spécialisés pour un diagnostic fiable.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-6 font-montserrat">
              Avantages de nos Services de Radiologie
            </h2>
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#c4bcb4] font-montserrat">
                    Images détaillées permettant un diagnostic précis et un traitement adapté.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Suivi Optimal</h3>
                  <p className="text-[#c4bcb4] font-montserrat">
                    Suivi précis de l'évolution de votre condition et de l'efficacité des traitements.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Radiographie</h3>
                <p className="text-[#c4bcb4] font-montserrat">Examens radiographiques standards pour diverses conditions médicales</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Échographie</h3>
                <p className="text-[#c4bcb4] font-montserrat">Imagerie par ultrasons pour l'évaluation des tissus mous</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">IRM</h3>
                <p className="text-[#c4bcb4] font-montserrat">Imagerie par résonance magnétique pour des vues détaillées des organes</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
        ...
        <section>
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-4 font-montserrat">
              Prêt à Bénéficier de nos Services de Radiologie ?
            </h2>
            <p className="text-xl text-white/90 mb-8 font-montserrat">
              Prenez rendez-vous dès aujourd'hui pour votre examen
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
