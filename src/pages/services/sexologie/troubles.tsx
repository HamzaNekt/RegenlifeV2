        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'sexologie', service: 'Troubles Sexuels' } })}
        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Diagnostic</h3>
              ...
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Traitement</h3>
                <p className="text-[#c4bcb4] font-montserrat">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Approche Globale</h3>
                  <p className="text-[#c4bcb4] font-montserrat">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-[#c4bcb4] font-montserrat">Analyse complète des troubles et identification des causes</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                ...
                <p className="text-[#c4bcb4] font-montserrat">Traitement personnalisé avec suivi régulier</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                ...
                <p className="text-[#c4bcb4] font-montserrat">Évaluation des progrès et ajustement du traitement</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
        ...
        <section>
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 font-montserrat">
              Prenez rendez-vous dès aujourd'hui pour votre traitement
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
