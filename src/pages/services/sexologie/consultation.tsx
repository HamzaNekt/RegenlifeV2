...
const ConsultationSexologique: React.FC = () => {
    ...
    <div className="min-h-screen bg-[#1c2431]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <p className="text-xl mb-8 font-montserrat">
              Une approche professionnelle et bienveillante pour évaluer et accompagner vos problématiques de santé sexuelle dans un cadre confidentiel.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'sexologie', service: 'Consultation' } })}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-6 font-montserrat">
              Qu'est-ce que la Consultation Sexologique ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              La consultation sexologique est un espace d'écoute et d'accompagnement professionnel où vous pouvez aborder librement vos questions et préoccupations concernant votre santé sexuelle. Notre approche est basée sur la bienveillance, la confidentialité et l'expertise.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Déroulement</h3>
                <p className="text-[#c4bcb4] font-montserrat">
                  Une première rencontre pour évaluer vos besoins, suivie d'un accompagnement personnalisé adapté à votre situation.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <p className="text-[#c4bcb4] font-montserrat">
                  Améliorer votre bien-être sexuel, résoudre les difficultés rencontrées et développer une sexualité épanouie.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-6 font-montserrat">
              Avantages de la Consultation Sexologique
            </h2>
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Accompagnement Personnalisé</h3>
                  <p className="text-[#c4bcb4] font-montserrat">
                    Une approche sur mesure adaptée à vos besoins spécifiques et à votre situation unique.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Confidentialité Totale</h3>
                  <p className="text-[#c4bcb4] font-montserrat">
                    Un cadre sécurisé et confidentiel pour aborder librement vos préoccupations.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Évaluation Initiale</h3>
                <p className="text-[#c4bcb4] font-montserrat">Analyse complète de votre situation et définition des objectifs</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Accompagnement</h3>
                <p className="text-[#c4bcb4] font-montserrat">Séances de suivi personnalisées selon vos besoins</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                ...
                <p className="text-[#c4bcb4] font-montserrat">Évaluation régulière des progrès et ajustement du suivi</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
        ...
        <section>
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 font-montserrat">
              Prenez rendez-vous dès aujourd'hui pour votre consultation sexologique
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
...
export default ConsultationSexologique; 