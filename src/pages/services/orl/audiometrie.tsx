...
import { FiArrowRight, FiHeadphones, FiActivity, FiCheckCircle, FiMapPin, FiTruck, FiHome } from 'react-icons/fi';
import { Link, useNavigate } from 'react-router-dom';
import LoadingSpinner from '../../../components/LoadingSpinner';

const Audiometrie: React.FC = () => {
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <p className="text-xl mb-8 font-montserrat">
              Évaluation précise de votre audition avec des équipements de pointe et des professionnels qualifiés.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'orl', service: 'Audiométrie' } })}
        ...
        <section className="mb-16">
          ...
          >
            ...
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              L'audiométrie est un examen qui permet d'évaluer précisément votre capacité auditive. Grâce à des tests spécifiques et des équipements modernes, nous pouvons mesurer votre seuil d'audition et identifier d'éventuels troubles auditifs.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Test Précis</h3>
                <p className="text-[#c4bcb4] font-montserrat">
                  Évaluation détaillée de votre audition dans différentes fréquences.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Résultats Immédiats</h3>
                <p className="text-[#c4bcb4] font-montserrat">
                  Analyse rapide et explication claire des résultats obtenus.
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Équipement de Pointe</h3>
                  <p className="text-[#c4bcb4] font-montserrat">
                    Utilisation d'audiomètres de dernière génération pour des mesures précises.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Expertise Professionnelle</h3>
                  <p className="text-[#c4bcb4] font-montserrat">
                    Tests réalisés par des audiologistes qualifiés et expérimentés.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Audiométrie Tonale</h3>
                <p className="text-[#c4bcb4] font-montserrat">Mesure des seuils d'audition pour différentes fréquences</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Audiométrie Vocale</h3>
                <p className="text-[#c4bcb4] font-montserrat">Évaluation de la compréhension de la parole</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Tympanométrie</h3>
                <p className="text-[#c4bcb4] font-montserrat">Analyse de la fonction de l'oreille moyenne</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
