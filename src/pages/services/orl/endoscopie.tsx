        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-blue-600 mb-3">Technique Avancée</h3>
              ...
              <motion.div 
                ...
                className="bg-blue-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-blue-600 mb-3">Confort Patient</h3>
                <p className="text-gray-700">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-blue-600 mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Sécurité Maximale</h3>
                  <p className="text-gray-700">
        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Endoscopie Nasale</h3>
                <p className="text-gray-700">Examen des fosses nasales et des sinus</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Laryngoscopie</h3>
                <p className="text-gray-700">Exploration du larynx et des cordes vocales</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Pharyngoscopie</h3>
                <p className="text-gray-700">Examen du pharynx et de l'oropharynx</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
