        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'cardiologie', service: 'Réadaptation Cardiaque' } })}
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Suivi Médical</h3>
                <p className="text-[#c4bcb4]">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Exercices Physiques</h3>
                <p className="text-[#c4bcb4]">Activités adaptées et progressives sous surveillance</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Éducation Thérapeutique</h3>
                <p className="text-[#c4bcb4]">Conseils et informations pour une meilleure gestion</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Support Psychologique</h3>
                <p className="text-[#c4bcb4]">Accompagnement pour le bien-être mental</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
