          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-gray-700">Évaluation complète de votre santé cardiaque</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Électrocardiogramme</h3>
                <p className="text-gray-700">Analyse de l'activité électrique du cœur</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                ...
                <p className="text-gray-700">Imagerie détaillée de la structure cardiaque</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
