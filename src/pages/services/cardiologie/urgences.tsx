        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Disponibilité 24/7</h3>
              ...
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Intervention Rapide</h3>
                <p className="text-[#c4bcb4]">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Équipe Spécialisée</h3>
                  <p className="text-[#c4bcb4]">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Douleurs Thoraciques</h3>
                <p className="text-[#c4bcb4]">Évaluation et traitement immédiat</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Arythmies</h3>
                <p className="text-[#c4bcb4]">Gestion des troubles du rythme cardiaque</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Arrêt Cardiaque</h3>
                <p className="text-[#c4bcb4]">Réanimation et stabilisation</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Accès Direct</h3>
                <p className="text-[#c4bcb4]">Entrée dédiée pour les urgences</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                ...
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Ambulance</h3>
                <p className="text-[#c4bcb4]">Service d'ambulance disponible 24/7</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                ...
                <p className="text-[#c4bcb4]">Salle d'attente pour les accompagnants</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
