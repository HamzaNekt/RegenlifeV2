...
const InstallationRetraite = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1c2431] relative overflow-x-hidden">
      {/* HERO */}
      <section className="relative h-[70vh] flex items-center justify-center pt-32 overflow-hidden" style={{ backgroundImage: 'url(/herobackground.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
