...
import { FiArrowRight, FiCheckCircle, FiMapPin, FiTruck, FiHome, FiZap } from 'react-icons/fi';
import { Link, useNavigate } from 'react-router-dom';
import LoadingSpinner from '../../../components/LoadingSpinner';

const SonicWaveTherapy: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1c2431]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-montserrat">
              Thérapie par Ondes de Choc en Traumatologie
            </h1>
            <p className="text-xl mb-8 font-montserrat">
              Une technologie avancée pour traiter les douleurs chroniques et accélérer la guérison des blessures sportives.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'traumatologie', service: 'Thérapie par Ondes de Choc' } })}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* What is Sonic Wave Therapy Section */}
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Qu'est-ce que la Thérapie par Ondes de Choc en Traumatologie ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              Une technique non-invasive utilisant des ondes acoustiques pour stimuler la guérison des tissus endommagés suite à des traumatismes ou des blessures sportives.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Stimulation de la Guérison</h3>
                <p className="text-[#c4bcb4]">
                  Activation des processus naturels de guérison pour réparer les lésions musculaires, tendineuses et articulaires.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Traitement Ciblé</h3>
                <p className="text-[#c4bcb4]">
                  Application précise des ondes de choc sur les zones traumatisées pour un maximum d'efficacité.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Avantages de la Thérapie par Ondes de Choc en Traumatologie
            </h2>
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Soulagement des Douleurs Chroniques</h3>
                  <p className="text-[#c4bcb4]">
                    Réduction significative des douleurs persistantes après traumatisme et amélioration de la mobilité.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Guérison Accélérée</h3>
                  <p className="text-[#c4bcb4]">
                    Stimulation de la régénération tissulaire pour une récupération plus rapide après blessure.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-[#c4bcb4]">Analyse de votre blessure et élaboration d'un plan de traitement personnalisé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Séances de Traitement</h3>
                <p className="text-[#c4bcb4]">Application des ondes de choc avec suivi médical spécialisé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Suivi de Récupération</h3>
                <p className="text-[#c4bcb4]">Évaluation des progrès et ajustement du traitement pour une guérison optimale</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
        ...
        <section>
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-4 font-montserrat">
              Prêt à Soulager Vos Douleurs après une Blessure ?
            </h2>
...
export default SonicWaveTherapy; 