        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-blue-600 mb-3">Stimulation de la Guérison</h3>
              ...
              <motion.div 
                ...
                className="bg-blue-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-blue-600 mb-3">Traitement Ciblé</h3>
                <p className="text-gray-700">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Soulagement des Douleurs Chroniques</h3>
                  <p className="text-gray-700">
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-blue-600 mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Guérison Accélérée</h3>
                  <p className="text-gray-700">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <motion.div 
                ...
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Séances de Traitement</h3>
                <p className="text-gray-700">Application des ondes de choc avec suivi médical spécialisé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
