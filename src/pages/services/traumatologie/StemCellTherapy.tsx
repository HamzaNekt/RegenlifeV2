        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-blue-600 mb-3">Régénération des Tissus Traumatisés</h3>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Guérison Accélérée des Blessures</h3>
                  <p className="text-gray-700">
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-blue-600 mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Retour à l'Activité Sportive</h3>
                  <p className="text-gray-700">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-gray-700">Analyse complète de votre blessure et élaboration d'un plan de traitement personnalisé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Traitement Cellulaire</h3>
                <p className="text-gray-700">Application de la thérapie par cellules souches avec suivi médical spécialisé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Rééducation Sportive</h3>
                <p className="text-gray-700">Programme de rééducation adapté pour un retour optimal à l'activité sportive</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
