    ...
    <div className="min-h-screen bg-[#1c2431]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-montserrat">
              Thérapie PRP en Traumatologie
            </h1>
            <p className="text-xl mb-8 font-montserrat">
              Une approche régénérative utilisant votre propre plasma riche en plaquettes pour accélérer la guérison des blessures sportives.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'traumatologie', service: 'Thérapie PRP' } })}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Qu'est-ce que la Thérapie PRP en Traumatologie ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              Une technique innovante qui utilise les facteurs de croissance naturels de votre sang pour stimuler la guérison des tissus endommagés suite à des traumatismes ou des blessures sportives.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Traitement Autologue</h3>
                <p className="text-[#c4bcb4]">
                  Utilisation de votre propre sang pour une thérapie naturelle et personnalisée après traumatisme.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Régénération Tissulaire</h3>
                <p className="text-[#c4bcb4]">
                  Stimulation des processus naturels de guérison pour réparer les lésions musculaires, tendineuses et articulaires.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Avantages de la Thérapie PRP en Traumatologie
            </h2>
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Guérison Naturelle</h3>
                  <p className="text-[#c4bcb4]">
                    Utilisation des facteurs de croissance naturels de votre corps pour une guérison optimale après traumatisme.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#c4bcb4]">
                    Stimulation de la régénération tissulaire pour un retour plus rapide à vos activités sportives.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Traitement PRP</h3>
                <p className="text-[#c4bcb4]">Application du plasma riche en plaquettes avec suivi médical spécialisé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
