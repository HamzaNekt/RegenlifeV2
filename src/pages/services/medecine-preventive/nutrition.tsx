...
const ConseilsNutrition: React.FC = () => {
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <p className="text-xl mb-8 font-montserrat">
              Un accompagnement personnalisé pour une alimentation saine et équilibrée adaptée à vos besoins.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'medecine-preventive', service: 'Conseils Nutritionnels' } })}
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Qu'est-ce que nos Conseils Nutrition ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              Nos conseils nutrition vous offrent un accompagnement personnalisé pour adopter une alimentation saine et équilibrée. Notre approche est basée sur vos besoins spécifiques et vos objectifs de santé.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                ...
                <p className="text-[#c4bcb4]">
                  Adopter une alimentation saine et équilibrée adaptée à vos besoins.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Conseils Personnalisés</h3>
                  <p className="text-[#c4bcb4]">
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Suivi Régulier</h3>
                  <p className="text-[#c4bcb4]">
                    Accompagnement continu pour maintenir vos bonnes habitudes.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Bilan Nutritionnel</h3>
                <p className="text-[#c4bcb4]">Évaluation de vos habitudes alimentaires</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Plan Alimentaire</h3>
                <p className="text-[#c4bcb4]">Menus adaptés à vos besoins</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Coaching</h3>
...
export default ConseilsNutrition; 
