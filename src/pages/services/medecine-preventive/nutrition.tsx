        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Bilan Nutritionnel</h3>
                <p className="text-gray-700">Évaluation de vos habitudes alimentaires</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Plan Alimentaire</h3>
                <p className="text-gray-700">Menus adaptés à vos besoins</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Coaching</h3>
