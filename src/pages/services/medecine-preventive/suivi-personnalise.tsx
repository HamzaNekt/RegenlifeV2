          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Suivi Individuel</h3>
                  <p className="text-gray-700">
        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Bilan Initial</h3>
              ...
              <motion.div 
                ...
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Suivi Régulier</h3>
                <p className="text-gray-700">Consultations adaptées à vos besoins</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
