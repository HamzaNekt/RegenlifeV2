        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <p className="text-xl mb-8 font-montserrat">
              Une évaluation complète de votre état de santé pour prévenir et détecter précocement d'éventuels problèmes de santé.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'medecine-preventive', service: 'Bilan de Santé' } })}
        ...
        <section className="mb-16">
          ...
          >
            ...
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              Le bilan de santé est un examen médical complet qui permet d'évaluer votre état de santé général et de détecter précocement d'éventuels problèmes. Notre approche est basée sur la prévention et le suivi personnalisé.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                ...
                <p className="text-[#c4bcb4]">
                  Évaluer votre état de santé général et détecter précocement d'éventuels problèmes.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <p className="text-[#c4bcb4]">
                  Approche personnalisée et adaptée à votre profil, basée sur des examens médicaux complets.
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Dépistage Précoce</h3>
                  <p className="text-[#c4bcb4]">
                    Détection précoce des problèmes de santé pour une prise en charge rapide.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Prévention</h3>
                  <p className="text-[#c4bcb4]">
                    Conseils personnalisés pour maintenir une bonne santé et prévenir les maladies.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Examen Clinique</h3>
              ...
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Analyses Médicales</h3>
                <p className="text-[#c4bcb4]">Examens biologiques et tests spécifiques</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Examens Complémentaires</h3>
                <p className="text-[#c4bcb4]">Imagerie médicale et tests spécialisés</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
