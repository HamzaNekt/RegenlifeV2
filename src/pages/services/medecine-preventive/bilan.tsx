          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Dépistage Précoce</h3>
                  <p className="text-gray-700">
        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Examen Clinique</h3>
                <p className="text-gray-700">Évaluation complète de votre état de santé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Analyses Médicales</h3>
                <p className="text-gray-700">Examens biologiques et tests spécifiques</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Examens Complémentaires</h3>
                <p className="text-gray-700">Imagerie médicale et tests spécialisés</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
