        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'medecine-preventive', service: 'Dépistage Précoce' } })}
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Tests Fiables</h3>
                  <p className="text-[#c4bcb4]">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Dépistage Cardiovasculaire</h3>
                <p className="text-[#c4bcb4]">Tests pour la santé cardiaque et vasculaire</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Dépistage du Cancer</h3>
                <p className="text-[#c4bcb4]">Tests pour la détection précoce des cancers</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Autres Dépistages</h3>
                <p className="text-[#c4bcb4]">Tests pour d'autres problèmes de santé</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
