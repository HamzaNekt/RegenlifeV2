        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-montserrat">
              Thérapie NAD+ en Biologie
            </h1>
            <p className="text-xl mb-8 font-montserrat">
              Une approche innovante pour optimiser votre santé cellulaire et votre bien-être.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'biologie', service: 'Thérapie NAD+' } })}
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Qu'est-ce que la Thérapie NAD+ ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              Une technique innovante qui utilise le NAD+ (Nicotinamide Adénine Dinucléotide) pour optimiser la fonction cellulaire et améliorer la santé.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Optimisation Cellulaire</h3>
                <p className="text-[#c4bcb4]">
                  Amélioration de la fonction cellulaire et de l'énergie pour une meilleure santé.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <p className="text-[#c4bcb4]">
                  Approche individualisée basée sur votre profil biologique pour des résultats optimaux.
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Énergie Cellulaire Améliorée</h3>
                  <p className="text-[#c4bcb4]">
                    Optimisation de la production d'énergie cellulaire pour une meilleure santé.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#c4bcb4]">
                    Effets prolongés grâce à une amélioration durable de la fonction cellulaire.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-[#c4bcb4]">Analyse de votre condition et élaboration d'un plan de traitement personnalisé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Thérapie NAD+</h3>
                <p className="text-[#c4bcb4]">Application précise du NAD+ pour optimiser votre santé cellulaire</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
        ...
        <section>
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-4 font-montserrat">
              Prêt à Optimiser Votre Santé Cellulaire avec la Thérapie NAD+ ?
            </h2>
