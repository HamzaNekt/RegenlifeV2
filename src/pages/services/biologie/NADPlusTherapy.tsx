        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-blue-600 mb-3">Optimisation Cellulaire</h3>
              ...
              <motion.div 
                ...
                className="bg-blue-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-blue-600 mb-3">Traitement Personnalisé</h3>
                <p className="text-gray-700">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Énergie Cellulaire Améliorée</h3>
                  <p className="text-gray-700">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-gray-700">Analyse de votre condition et élaboration d'un plan de traitement personnalisé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Thérapie NAD+</h3>
                <p className="text-gray-700">Application précise du NAD+ pour optimiser votre santé cellulaire</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
