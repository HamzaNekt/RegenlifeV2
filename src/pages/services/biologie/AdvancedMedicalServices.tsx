  ...
  return (
    <div className="min-h-screen bg-[#1c2431]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-montserrat">
              Services Médicaux Avancés en Biologie
            </h1>
            <p className="text-xl mb-8 font-montserrat">
              Des solutions médicales innovantes pour optimiser votre santé et votre bien-être.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'biologie', service: 'Services Médicaux Avancés' } })}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* What is Advanced Medical Services Section */}
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Qu'est-ce que les Services Médicaux Avancés en Biologie ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              Une approche innovante combinant les dernières avancées en médecine biologique pour optimiser votre santé et votre bien-être.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Médecine Personnalisée</h3>
                <p className="text-[#c4bcb4]">
                  Approche individualisée basée sur votre profil biologique unique pour des résultats optimaux.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Technologies Avancées</h3>
                <p className="text-[#c4bcb4]">
                  Utilisation des dernières innovations en médecine biologique pour des traitements efficaces.
                </p>
              </motion.div>
            </div>
          </motion.div>
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Avantages des Services Médicaux Avancés
            </h2>
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Traitements Personnalisés</h3>
                  <p className="text-[#c4bcb4]">
                    Approche individualisée basée sur votre profil biologique unique pour des résultats optimaux.
                  </p>
                </div>
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Résultats Durables</h3>
                  <p className="text-[#c4bcb4]">
                    Effets prolongés grâce à des traitements biologiques innovants et personnalisés.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Évaluation Biologique</h3>
                <p className="text-[#c4bcb4]">Analyse approfondie de votre profil biologique et élaboration d'un plan de traitement personnalisé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Traitements Avancés</h3>
                <p className="text-[#c4bcb4]">Application des dernières innovations en médecine biologique</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                ...
                <p className="text-[#c4bcb4]">Évaluation des résultats et recommandations pour maintenir les effets</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
        ...
        <section>
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-4 font-montserrat">
              Prêt à Découvrir les Avantages de la Médecine Biologique ?
            </h2>
...
export default AdvancedMedicalServices; 