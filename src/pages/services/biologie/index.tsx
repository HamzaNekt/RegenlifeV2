        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                >
                  <div className="relative h-full bg-[#2e333f] rounded-2xl shadow-lg overflow-hidden transition-all duration-300 group-hover:shadow-xl">
                    {/* Gradient Overlay (désactivé pour cohérence urologie) */}
                    ...
                    <div className="p-8 h-full flex flex-col">
                      ...
                      <h3 className="text-2xl font-semibold text-white mb-3 group-hover:text-[#D1A24C] font-montserrat transition-colors duration-300">
                        {service.title}
                      </h3>
                      <p className="text-[#c4bcb4] mb-6 flex-grow font-montserrat">
                        {service.description}
                      </p>
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'biologie', service: 'général' } })}
