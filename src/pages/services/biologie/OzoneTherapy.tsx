        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'biologie', service: 'Thérapie Ozone' } })}
        ...
        <section className="mb-16">
          ...
          >
            ...
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              Une technique innovante qui utilise l'ozone médical pour stimuler le système immunitaire et améliorer la santé cellulaire.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Stimulation Immunitaire</h3>
                <p className="text-[#c4bcb4]">
                  Renforcement naturel de votre système immunitaire pour une meilleure santé.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#c4bcb4]">
                    Optimisation de la fonction cellulaire et de l'oxygénation pour une meilleure santé.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#c4bcb4]">
                    Effets prolongés grâce à une amélioration durable de la santé cellulaire.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Ozonothérapie</h3>
                <p className="text-[#c4bcb4]">Application précise de l'ozone médical pour optimiser votre santé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
        ...
        <section>
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-4 font-montserrat">
              Prêt à Optimiser Votre Santé avec l'Ozonothérapie ?
            </h2>
