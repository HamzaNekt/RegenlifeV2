        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-blue-600 mb-3">Stimulation Immunitaire</h3>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <motion.div 
                ...
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Ozonothérapie</h3>
                <p className="text-gray-700">Application précise de l'ozone médical pour optimiser votre santé</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
