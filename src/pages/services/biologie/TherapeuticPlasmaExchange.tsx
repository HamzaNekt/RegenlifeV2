  ...
  return (
    <div className="min-h-screen bg-[#1c2431]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-montserrat">
              Échange Plasmatique Thérapeutique en Biologie
            </h1>
            <p className="text-xl mb-8 font-montserrat">
              Une approche innovante pour purifier votre sang et optimiser votre santé.
            </p>
            <motion.button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* What is Therapeutic Plasma Exchange Section */}
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Qu'est-ce que l'Échange Plasmatique Thérapeutique ?
            </h2>
            <p className="text-lg text-[#c4bcb4] mb-6 font-montserrat">
              Une technique innovante qui permet de purifier votre sang en remplaçant le plasma par une solution stérile, éliminant ainsi les substances nocives.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                <h3 className="text-xl font-semibold text-[#D1A24C] mb-3 font-montserrat">Purification du Sang</h3>
                <p className="text-[#c4bcb4]">
                  Élimination des substances nocives et des toxines de votre sang pour une meilleure santé.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
        ...
        <section className="mb-16">
          ...
          >
            <h2 className="text-3xl font-bold text-[#D1A24C] mb-6 font-montserrat">
              Avantages de l'Échange Plasmatique Thérapeutique
            </h2>
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Purification Efficace</h3>
                  <p className="text-[#c4bcb4]">
                    Élimination efficace des substances nocives et des toxines de votre sang.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#c4bcb4]">
                    Effets prolongés grâce à une purification complète du sang.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Échange Plasmatique</h3>
                <p className="text-[#c4bcb4]">Procédure précise d'échange plasmatique pour purifier votre sang</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
        ...
        <section>
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-4 font-montserrat">
              Prêt à Purifier Votre Sang et Optimiser Votre Santé ?
            </h2>
...
export default TherapeuticPlasmaExchange; 