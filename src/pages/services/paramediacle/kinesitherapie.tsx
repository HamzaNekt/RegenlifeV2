        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={() => navigate('/contact', { state: { specialite: 'paramediacle', service: 'Kinésithérapie' } })}
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-[#D1A24C] mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2 font-montserrat">Récupération Fonctionnelle</h3>
                  <p className="text-[#c4bcb4] font-montserrat">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <motion.div 
                ...
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Rééducation Fonctionnelle</h3>
                <p className="text-[#c4bcb4] font-montserrat">Restauration des fonctions motrices après blessure ou chirurgie.</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Renforcement Musculaire</h3>
                <p className="text-[#c4bcb4] font-montserrat">Programmes personnalisés pour renforcer les muscles et prévenir les blessures.</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Thérapie Manuelle</h3>
                <p className="text-[#c4bcb4] font-montserrat">Techniques manuelles pour soulager la douleur et améliorer la mobilité.</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-[#1c2431] p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-white mb-3 font-montserrat">Rééducation Cardio-Respiratoire</h3>
                <p className="text-[#c4bcb4] font-montserrat">Prise en charge des troubles respiratoires et amélioration de l'endurance.</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
