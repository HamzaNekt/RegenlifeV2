        ...
        <section className="mb-16">
          ...
          >
            ...
            <p className="text-lg text-gray-700 mb-6">
              L'ostéopathie est une thérapie manuelle globale visant à rétablir la mobilité des structures du corps (os, muscles, organes) pour favoriser l'auto-guérison et le bien-être général.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              >
                ...
                <p className="text-gray-700">
                  Bilan ostéopathique, techniques manuelles douces et adaptées, suivi personnalisé pour chaque patient.
                </p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
              ...
              >
                ...
                <p className="text-gray-700">
                  Soulagement des douleurs, amélioration de la mobilité, réduction du stress et du déséquilibre fonctionnel.
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Soulagement des Douleurs</h3>
                  <p className="text-gray-700">
                    Diminution des douleurs musculo-squelettiques, articulaires et viscérales.
                  </p>
                </div>
              </motion.div>
              <motion.div 
              ...
              >
                <FiCheckCircle className="w-6 h-6 text-blue-600 mt-1" />
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Amélioration de la Mobilité</h3>
                  <p className="text-gray-700">
                    Restauration de la mobilité articulaire et tissulaire pour un meilleur confort au quotidien.
                  </p>
                </div>
              </motion.div>
            </div>
        ...
        <section className="mb-16">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Ostéopathie Structurelle</h3>
                <p className="text-gray-700">Traitement des troubles musculo-squelettiques pour restaurer la mobilité.</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Ostéopathie Crânienne</h3>
                <p className="text-gray-700">Approche douce pour soulager les tensions et améliorer le bien-être global.</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Ostéopathie Viscérale</h3>
                <p className="text-gray-700">Travail sur la mobilité des organes internes pour optimiser la santé.</p>
              </motion.div>
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-gray-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Ostéopathie Pédiatrique</h3>
                <p className="text-gray-700">Prise en charge adaptée pour les nourrissons et enfants.</p>
              </motion.div>
            </div>
          </motion.div>
        </section>
